...
async function authFetch (url, data) {
	try {
		const response = await fetch(`https://discord.com/api/v10/${url}`, { method: 'POST', headers: { 'Content-Type': 'application/x-www-form-urlencoded' }, body: new URLSearchParams(data) });
